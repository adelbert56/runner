...
<!-- monstrare:gate-rules -->
## Monstrare Gate Workflow

Backfilled from Monstrare (https://github.com/pjwang2022/Monstrare). Full rules in `ai/process/workflow.md`.
