...
assertCheck(/function weeklyCoachLetterBody\(/.test(trainer) && /本週教練信/.test(trainer) && /coach-letter-fold/.test(trainer) && /details class="day-fold"/.test(trainer), "weekly coach letter folds into the week overview and non-today day cards collapse their details");
