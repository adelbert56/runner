...
assertCheck(/function preserveCoachWorkoutSteps\(/.test(garminReviewBuilder) && /function normalizeCoachSteps\(/.test(garminReviewBuilder) && /function refreshReviewFromGarmin\(/.test(garminReviewBuilder) && /updatedAt: asOf/.test(garminReviewBuilder) && /weekStart: nextStart/.test(garminReviewBuilder), "encrypted coach review preserves structured steps while rebuilding the current Garmin week and next-week boundary");
